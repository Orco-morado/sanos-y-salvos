...
Dueños: http://localhost:8080/api/v1/duenios/ (puerto interno 8095)  
...
| Microservicio | Puerto Interno |
|--------------|:--------------:|
| gateway       | 8080 |
| mascota-service | 8081 |
| comuna-service | 8083 |
| refugio-service | 8084 |
| veterinaria-service | 8085 |
| reporte-avistamiento-service | 8086 |
| reporte-desaparicion-service | 8087 |
| detalles-encuentro-service | 8088 |
| historial-mascota-service | 8089 |
| hallador-service | 8091 |
| duenio-service | 8095 |
| eureka-server | 8761 |
